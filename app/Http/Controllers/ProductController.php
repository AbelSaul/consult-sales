...
class ProductController extends Controller
{
    public function index()
    {
        ...
        kardex.idlocal, SUM(entrada)-SUM(salida) as stock,
        					...
        					WHERE (productos.idlocal=1 OR productos.idlocal=0) AND (kardex.idlocal='" . $user["idlocal"] . "' or kardex.idlocal IS NULL) AND productos.estado='A' 
